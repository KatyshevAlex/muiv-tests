...
public class Test {
    ...
    public void saveToFile() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(quizScreen.getRootPane(), "Для вопроса " + e.getNumber() +
        ...
        JOptionPane.showMessageDialog(quizScreen.getRootPane(), "Успешно сохранено в файл ",
